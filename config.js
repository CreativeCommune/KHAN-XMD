...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "",  // Your bot's session ID (IK~QaclEaDQ#4FsIyFMtPO4qPv5E2x5zdFslE21_6UfuUBD4ikrCyxc)
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Jᴀᴡᴀᴅ TᴇᴄʜX",           // Owner's name Aphelele mfoka Samela 🔥 🔥 
    ...
    STICKER_NAME: process.env.STICKER_NAME || "ᴋʜᴀɴ-ᴍᴅ",     // Sticker pack name♥️💚✈️💛
